    ...
    return {
        view: function () {
            return m('', {style: {paddingTop: "16px"}},
                m(Container,
                    m(Callout, {
                        content: "A vLEI Role Credential issued to representatives of a Legal Entity in other than official roles but in functional or other context of engagement"
                    })),
